...
//		exec.runGameTimed(new Human(),new AttractRepelGhosts(true),true);
		...
		double[] chromosome = {0.021928292,		//PROPENSION_HAUT
				0.001017273,					//PROPENSION_DROITE
				0.00916914,						//PROPENSION_BAS
				0,								//PROPENSION_GAUCHE
				0.132778877,					//GOURMANDISE
				0.941340165,					//COUARDISE
				0.405468066,					//AGGRESSIVITE
				0.007136159,					//STUPIDITE
				0.099604288,					//MAL_DE_VIVRE
				2.82E-04,						//INDECISION
				0,								//DIST_PEUR
				0,								//DIST_GOURMAND
				0 								//DIST_AGGRESSION
		};
		exec.runGame(new PacmanControllerApprenant(chromosome),new RandomGhosts(),true, 20);
...
//		exec.replayGame("human-v-Legacy2.txt");
    ...
    /* **************************************************************** */
    /* FONCTION MODIFIEE POUR RENVOYER LE SCORE MOYEN DES trials ESSAIS */
    /* **************************************************************** */
    /*
     ...
     */
    public float runExperiment(PacManController pacManController,GhostController ghostController,int trials)
    {
    	double avgScore=0;
